"""
Django settings for cloude_storage project.
...
# DATA_UPLOAD_MAX_MEMORY_SIZE = None # Размер файла пока так
...
AUTH_USER_MODEL = 'cloude_app.User'
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "cloude_app.serializers.CustomTokenObtainPairSerializer",
